...
class ClientCore {
        ...
        try (Socket socket = new Socket("localhost", 9999)) {
            ...
            while (true) {
                ...
                JOptionPane.showMessageDialog(null,
                        "Welcome to The Marketplace!", "Welcome", JOptionPane.PLAIN_MESSAGE);
                String[] options = {"Login", "Signup"};
                loginSignup = JOptionPane.showOptionDialog(null,
                        "Login or signup to use our service.", "Login",
                ...
                while (true) {
                    if (loginSignup == 0) { // THIS IS THE LOGIN PART
                        ...
                        while (true) {
                            ...
                            password = JOptionPane.showInputDialog("Please enter your password (no commas)");
                            userEmail = email;
                        ...
                        email = JOptionPane.showInputDialog("Please enter your email");
                        password = JOptionPane.showInputDialog("Please enter your password (no commas)");
                        username = JOptionPane.showInputDialog("Please enter your username (no commas)");
                        userEmail = email;
                        customer_seller:
                        while (true) {
                            String[] options1 = {"Customer", "Seller"};
                            customerSeller = String.valueOf(JOptionPane.showOptionDialog(null,
                                    "Are you signing up to be a customer or seller?", "Signup",
    ...
    public static boolean tryAgain(String message) {
        ...
        int yn = JOptionPane.showOptionDialog(null,
                "Please enter Yes to try again or No to quit.", "try again",
    ...
    public static void customerMainMenu() throws IOException {
        ...
        String[] options = {"Open Marketplace", "Search for Fruit", "View Shopping Cart ("
                + totalHeldProducts + " Fruits)", "View Purchase History",
                "View Statistics Dashboard", "Delete Account", "Logout & Quit"};
        int action = JOptionPane.showOptionDialog(null,
                "What would you like to do today?", "Choice",
                JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
    ...
    public static void marketplaceMenu() throws IOException {
        ...
        if (!products.isEmpty()) {
                ...
                if (productPick.equals("QUIT_MENU_PLEASE")) {
                    ...
                    if (Integer.parseInt(response[4]) <= 0) { //quantity <= 0
                        while (Integer.parseInt(response[4]) <= 0) { //quantity <= 0
                            productPick = JOptionPane.showInputDialog(
                                    "There is no more of this fruit available to purchase! " +
                            ...
                            if (productPick.matches("-?\\d+(\\.\\d+)?")
                                ...
                                if (Integer.parseInt(response[4]) >= 1) {
                                    if (response[0].equals("{getProductByName}")) { // TODO: needs testing
                                        ...
                                        int productAction = JOptionPane.showOptionDialog(null,
                                                "Please choose.", "Choice", JOptionPane.DEFAULT_OPTION,
                                                JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
                                        if (productAction == 0) {
                                            String purchaseQuantity = JOptionPane.showInputDialog(
                                                    "Please enter a purchase quantity: ");
                                            while (!purchaseQuantity.matches("-?\\d+(\\.\\d+)?")
                                                    || (Integer.parseInt(purchaseQuantity) < 1)) {
                                                purchaseQuantity = JOptionPane.showInputDialog(
                                                        "Entered quantity is not a valid integer! " +
                                                        "Please enter a valid quantity: ");
                                            }
                                            while (Integer.parseInt(response[4]) - Integer.parseInt(purchaseQuantity) < 0) {
                                                purchaseQuantity = JOptionPane.showInputDialog(
                                                        "There is only " + Integer.parseInt(response[4]) + " of " +
                                                        "this fruit available to purchase. Please try a smaller quantity:");
                                            }

                                            request =
                                                    "{addToCustomerShoppingCart}," + userEmail + ","
                                                            + allProducts.get(Integer.parseInt(productPick) - 1)
                                                            + "," + purchaseQuantity;
                                            clientOut.println(request);
                                            serverIn.readLine();
                                            request =
                                                    "{subtractProductQuantity}," + response[1] + ","
                                            ...
                                            JOptionPane.showMessageDialog(null,
                                                    "Successfully added " + purchaseQuantity
                        ...
                        if (currentProduct != null) {
                            ...
                            int productAction = JOptionPane.showOptionDialog(null,
                                    "Please choose one.", "Choice", JOptionPane.DEFAULT_OPTION,
                                    JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
                            ...
                            if (productAction == 0) {
                                ...
                                while (!purchaseQuantity.matches("-?\\d+(\\.\\d+)?")
                                        || (Integer.parseInt(purchaseQuantity) < 1)) {
                                    purchaseQuantity = JOptionPane.showInputDialog(
                                            "Entered quantity is not a valid integer! Please enter a valid quantity:");
                                }
                                while (Integer.parseInt(currentProduct[4]) - Integer.parseInt(purchaseQuantity) < 0) { // quantity - purchase quantity
                                    purchaseQuantity = JOptionPane.showInputDialog(
                                            "There is only " + currentProduct[4] + " of " +
                                            "this fruit available to purchase. Please try a smaller quantity: ");
                                }

                                request =
                                        "{addToCustomerShoppingCart}," + userEmail + ","
                                                + allProducts.get(Integer.parseInt(productPick) - 1) + "," + purchaseQuantity;
                                clientOut.println(request);
                                serverIn.readLine();
                                request =
                                        "{subtractProductQuantity}," + currentProduct[1] + ","
                                                + Integer.parseInt(purchaseQuantity);
                                clientOut.println(request);
                                serverIn.readLine();
                                // TESTING
            ...
            int noProdAction = JOptionPane.showOptionDialog(null,
                    "No fruits available. Please choose one.", "Choice", JOptionPane.DEFAULT_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
    ...
    public static void searchMenu() throws IOException {
        ...
        int searchAction = JOptionPane.showOptionDialog(null,
                "What would you like to search for?", "Search", JOptionPane.DEFAULT_OPTION,
                JOptionPane.QUESTION_MESSAGE, null, options, options[0]);

        if (searchAction == 0) { //search by name
            String searchParam = JOptionPane.showInputDialog("Please enter your search parameter (no commas)");
                ...
                if (productPick.equals("QUIT_MENU_PLEASE")) {
                    ...
                    if (Integer.parseInt(response[4]) <= 0) {
                                ...
                                if (Integer.parseInt(response[4]) >= 1) {
                                    if (response[0].equals("{getProductByName}")) { // TODO: needs testing
                                        ...
                                        if (productAction == 0) {
                                            ...
                                            request =
                                                    "{addToCustomerShoppingCart}," + userEmail + ","
                                                            + productsFound.get(Integer.parseInt(productPick) - 1)
                                                            + "," + purchaseQuantity;
                                            clientOut.println(request);
                                            serverIn.readLine();
                                            request =
                        ...
                        if (productAction == 0) {
                            ...
                            while (Integer.parseInt(response[4]) - Integer.parseInt(purchaseQuantity) < 0) {
                                purchaseQuantity = JOptionPane.showInputDialog("There is only " +
                            ...
                            request =
                                    "{addToCustomerShoppingCart}," + userEmail + ","
                                            + productsFound.get(Integer.parseInt(productPick) - 1) + "," + purchaseQuantity;
                            clientOut.println(request);
                            serverIn.readLine();
                            request =
    ...
    public static void cartMenu() throws IOException {
        ...
        if (heldSales.isEmpty()) {
            ...
            int noProdAction = JOptionPane.showOptionDialog(null,
                    "Your shopping cart is empty. Please choose one.",
                    "Choice",
                    JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
            ...
            if (cartPick.matches("-?\\d+(\\.\\d+)?")) {
                ...
                if (cartPick.equals("QUIT_MENU_PLEASE")) {
                    ...
                    if (response[0].equals("{getSaleByName}")) {
                        showProductInfo(currentProduct);
                        String[] options = {"Remove from Shopping Cart", "Change Purchase Quantity",
                                "Return to All Fruits Page"};
                        int cartAction = JOptionPane.showOptionDialog(null,
                                "Please choose one", "Choice", JOptionPane.DEFAULT_OPTION,
                                JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
                        ...
                        // TESTING
                         */
                            request = "{updateQuantityInShoppingCart}," + userEmail + ","
                                    + (Integer.parseInt(cartPick) - 1) + "," + Integer.parseInt(changeQuantity);
                            clientOut.println(request);
                            response = interpretResponse(serverIn.readLine());
                ...
                int purchaseAction = JOptionPane.showOptionDialog(null, "You are purchasing "
                        + heldProducts
                        + " fruits for $" + allTotalPrice + ". Would you like to complete the purchase?",
                        "Choose", JOptionPane.YES_NO_OPTION, JOptionPane.NO_OPTION, null, options, options[0]);
                if (purchaseAction == 0) {
    ...
    public static void historyMenu() throws IOException {
        ...
        int action = JOptionPane.showOptionDialog(null, "Please choose:",
                "Choice", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
    ...
    public static void dashboardMenu(int sortMode) throws IOException {
        ...
        if (userType.equals("C")) {
            ...
            if (stores.isEmpty()) {
                ...
                int noProdAction = JOptionPane.showOptionDialog(null,
                        "There are currently no stores on The " +
                ...
                String[] options = {"Sort Stores by Total Fruits Sold (High to Low)",
                        "Sort Stores by Total Fruits Sold (Low to High)",
                        "Sort Stores by Total Fruits Sold to You (High to Low)",
                        "Sort Stores by Total Fruits Sold to You (Low to High)", "Return to Customer Menu"};
    ...
    public static void customerSalesStatsDashboard(int sortMode) throws IOException {
        ...
        String[] options = {"Sort Products by Sales (High to Low)", "Sort Products by Sales (Low to High)",
                "Return to Statistics Dashboard Menu"};
        int productPick = JOptionPane.showOptionDialog(null,
                "Please enter:", "Choice", JOptionPane.DEFAULT_OPTION,
                JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
    ...
    public static void deleteAccount(String userEmail) throws IOException {
        ...
        int action = JOptionPane.showOptionDialog(null, warning,
                "Warning", JOptionPane.WARNING_MESSAGE, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
        if (action == 0) {
    ...
    public static void sellerMainMenu() throws IOException {
        String[] options = {"View Your Stores", "View Your Carted Fruits",
                "View Sales History", "View Statistics Dashboard", "Delete Account", "Logout & Quit"};
        int action = JOptionPane.showOptionDialog(null,
                ...
                try {
                    ...
                    if (productPick.matches("-?\\d+(\\.\\d+)?")) {
                        if (products != null) {
                            ...
                            String[] options = {"Change Quantity Available", "Change Description",
                                    "Change Price", "Remove Fruit", "Return to Seller Menu"};
                            int productAction = JOptionPane.showOptionDialog(null,
                                    "Please enter: ", "Product", JOptionPane.DEFAULT_OPTION,
                                    JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
                            ...
                            if (productAction == 0) {
                                ...
                                JOptionPane.showMessageDialog(null, "Successfully updated " + productName
                                        ...
                                        "returning", JOptionPane.INFORMATION_MESSAGE);
                                storesMenu();


                            } else if (productAction == 1) {

                                String desc = JOptionPane.showInputDialog("Please enter a new fruit description (no commas): ");
                                ...
                                int action = JOptionPane.showOptionDialog(null, show,
                                        "Warning", JOptionPane.DEFAULT_OPTION,
                                        JOptionPane.QUESTION_MESSAGE, null, optionsTwo, optionsTwo[0]);
                        ...
                        */
                        ...
                        JOptionPane.showMessageDialog(null, "Returning to all stores menu...",
    ...
    public static void addNewStore() throws IOException {
        String name = JOptionPane.showInputDialog("Enter new store name (no commas): ");
    ...
    public static void addNewProduct(String storeName) throws IOException {
        String name = JOptionPane.showInputDialog("Enter new fruit name (no commas): ");
        ...
        if (name.contains(",") || name.contains(";")) {
            ...
            String desc = JOptionPane.showInputDialog("Enter fruit description (no commas): ");
    ...
    public static void printFarewell() {
        JOptionPane.showMessageDialog(null,
                "Thank you for visiting The MarketPlace!\nCome again another day.",
